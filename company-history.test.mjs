...
function row(num, company, status, date, notes = '') {
  return { num, date, company, role: 'Engineer', score: '80/100', status, pdf: '✅', report: `reports/${num}.md`, notes };
}
...

{
  ...
  try {
    ...
    const trackerContent = [
      ...
      '|---|------|---------|------|-------|--------|-----|--------|-------|',
      '| 1 | 2026-01-01 | LoaderCo | Engineer | 80/100 | Applied | ✅ | [1](reports/1.md) | Applied 2026-01-05 |',
    ].join('\n');
