...
function selfTest() {
  ...
  const mkTracker = (applied, responded) => {
    ...
    const rows = [];
    let n = 1;
    for (let i = 0; i < applied; i++) rows.push(`| ${n++} | 2026-06-01 | Co${n} | Role | 80/100 | Applied | ❌ | - | |`);
    for (let i = 0; i < responded; i++) rows.push(`| ${n++} | 2026-06-01 | Co${n} | Role | 80/100 | Responded | ❌ | - | Applied 2026-06-01 |`);
    return `${header}\n${rows.join('\n')}`;
  };
  ...
  const waitTracker = [
    ...
    '|---|------|---------|------|-------|--------|-----|--------|-------|',
    '| 1 | 2026-06-01 | LogCo | Role | 80/100 | Applied | ❌ | - | |',
    '| 2 | 2026-06-01 | NotesCo | Role | 80/100 | Applied | ❌ | - | Applied 2026-07-01 |',
    '| 3 | 2026-06-01 | UnknownCo | Role | 80/100 | Applied | ❌ | - | evaluated only |',
    '| 4 | 2026-06-01 | DoneCo | Role | 80/100 | Responded | ❌ | - | Applied 2026-06-01 |',
  ].join('\n');
  ...
  const noncanonTracker = [
    '| # | Date | Company | Role | Score | Status | PDF | Report | Notes |',
    '|---|------|---------|------|-------|--------|-----|--------|-------|',
    '| 1 | 2026-06-01 | CanonCo | Role | 80/100 | Applied | ❌ | - | Applied 2026-07-01 |',
    '| 2 | 2026-06-01 | LowerCo | Role | 80/100 | applied | ❌ | - | Applied 2026-07-01 |',
    '| 3 | 2026-06-01 | DatedCo | Role | 80/100 | Applied 2026-06-01 | ❌ | - | Applied 2026-07-01 |',
    '| 4 | 2026-06-01 | LocaleCo | Role | 80/100 | Aplicado | ❌ | - | Applied 2026-07-01 |',
    '| 5 | 2026-06-01 | BoldCo | Role | 80/100 | **Applied** | ❌ | - | Applied 2026-07-01 |',
  ].join('\n');
