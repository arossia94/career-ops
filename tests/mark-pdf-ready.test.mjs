...
|---|------|---------|-----|------|-------|--------|-----|--------|-------|
| 3 | 2026-06-03 | Initech | — | AI Engineer | 90/100 | Evaluated | ❌ | [3](../reports/003-initech-2026-06-03.md) | — |
`;
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 8 | 2026-06-08 | University of Alberta | Curriculum Coordinator | 76/100 | Evaluated | ❌ | [9](../reports/009-university-of-alberta-2026-06-08.md) | dup report link |
| 9 | 2026-06-09 | Esri Canada | Talent Development | 82/100 | Evaluated | ❌ | [9](../reports/009-esri-canada-2026-06-09.md) | dup report link |
`;
...
// ── 1. Happy path: flips ❌→✅ for the row linking the given report# ──
{
  ...
  try {
    ...
    if (r.code === 0 && /\| 1 \| 2026-06-01 \| Acme \| Backend Engineer \| 84\/100 \| Evaluated \| ✅ \|/.test(content)) {
      pass('happy path: PDF cell flipped ❌→✅ for the matching report');
    } else {
      fail(`happy path: code=${r.code}; row not updated correctly\n${r.stdout}${r.stderr}`);
    }
    if (content.includes('| 2 | 2026-06-02 | Globex | Platform Engineer | 80/100 | Evaluated | ✅ |')) {
...
// ── 7. 10-column layout with a Via column ──
{
  ...
  try {
    ...
    if (r.code === 0 && /\| 3 \| 2026-06-03 \| Initech \| — \| AI Engineer \| 90\/100 \| Evaluated \| ✅ \|/.test(content)) {
...
|---|------|---------|------|-------|--------|--------|-------|
| 1 | 2026-06-01 | Acme | Backend Engineer | 84/100 | Evaluated | [1](../reports/001-acme-2026-06-01.md) | — |
`;
