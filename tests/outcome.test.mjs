...
|---|------|---------|------|-------|--------|-----|--------|-------|
| 1 | 2026-07-01 | Acme Corp | Senior Backend Engineer | 90/100 | Applied | local:output/acme.pdf | local:reports/1-acme.md | Applied online |
| 2 | 2026-07-02 | Beta Systems | Lead AI Architect | 96/100 | Interview | local:output/beta.pdf | local:reports/2-beta.md | Screen passed |
`;
...
try {
  ...
  check('Tracker row #1 status updated to Interview', trackerContent1.includes('| 1 | 2026-07-01 | Acme Corp | Senior Backend Engineer | 90/100 | Interview |'));
  ...
  check('Tracker row #1 status updated to Offer', trackerContent2.includes('| 1 | 2026-07-01 | Acme Corp | Senior Backend Engineer | 90/100 | Offer |'));
