...
//
//   a successful worker has status="completed", error EMPTY, score=68
//   emitted:  completed \t \t 68
//
...
//
//   parsed_status="completed"  parsed_error="68"  parsed_score=""
//
  ...
  if (!nodeProg) {
    ...
    try {
      ...
      writeFileSync(script, [
        '#!/usr/bin/env bash',
        `worker_result_json='{"status":"completed","error":null,"score":68}'`,
      ...
      if (score === '68') {
        ...
        fail(`score was recorded as "${score}" instead of 68 — the empty error field collapsed the split`);
      }
