...
|-----------|------|----------------|
| Alineación North Star | 20% | 5=rol target exacto, 1=no relacionado |
| Match CV | 25% | 5=90%+ match, 1=<40% match o missing minimum requirements |
| Nivel (senior+) | 5% | 5=staff+, 4=senior, 3=mid-senior, 2=mid, 1=junior |
| Comp estimada | 10% | 5=top quartile, 1=below market |
| Trayectoria crecimiento | 10% | 5=clear path to next level, 1=dead end |
| Calidad remoto | 0% | 5=full remote async, 1=onsite only |
