...
2. **Für jede offene URL**:
   ...
   d. **Vollständige Auto-Pipeline ausführen**: A-F-Bewertung → Report .md → PDF (wenn Score >= 70.0) → Tracker
   e. **Von "Offen" nach "Verarbeitet" verschieben**: `- [x] #NNN | URL | Firma | Rolle | Score/100 | PDF ✅/❌`
