...
// e.g. two workers that fabricated a placeholder score (0/100, "Suspicious")
 ...
 * existing duplicate row. Markdown bolding and `/100` suffixes are presentation
 * details, so only the first numeric value is used.
 *
 * @param {string} s - Raw score cell such as `84/100`.
