...
func TestUpdateApplicationStatusWaitsForSharedLock(t *testing.T) {
	...
	concurrentRow := "| 99 | 2026-06-02 | Concurrent Co | Engineer | Remote | 80/100 | Evaluated | ❌ | [99](reports/099.md) | concurrent update |"
...
|---|------|---------|------|-------|--------|-----|--------|-------|
| 7 | 2026-06-23 | Applied Materials | Staff Android Engineer | 84/100 | Applied | ✅ | [7](reports/007.md) | substring trap |
`
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 140 | 2026-04-16 | Arize AI | AI Engineer, Instrumentation | 94/100 | Evaluated | ✅ | [140](reports/140-arize-ai-engineer-instrumentation-2026-04-16.md) | Strong fit |
| 143 | 2026-04-16 | Arize AI | AI Sales Engineer, US | 82/100 | Evaluated | ❌ | [143](reports/143-arize-ai-sales-engineer-us-2026-04-16.md) | Good fit |
`
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 1 | 2026-06-03 | Acme | Engineer | 80/100 | Evaluated | ✅ | [1](../reports/001-acme-2026-06-03.md) | Tracker-relative link |
| 2 | 2026-06-03 | Legacy Co | Engineer | 60/100 | Evaluated | ❌ | [2](reports/002-legacy-2026-06-03.md) | Legacy root-relative link |
`
...
|---|------|---------|------|----------|-------|--------|-----|--------|-------|
| 1 | 2026-06-01 | Acme | VP Marketing | Remote | 90/100 | Applied | ✅ | [1](reports/001.md) | hot lead |
`
...
func TestParseApplicationsMapsColumnsByHeader(t *testing.T) {
	...
	if a.ScoreRaw != "90/100" {
		t.Errorf("ScoreRaw = %q, want \"90/100\"", a.ScoreRaw)
	}
	if !a.HasPDF {
...
func TestUpdateApplicationStatusInsertedColumn(t *testing.T) {
	...
	for _, cell := range []string{"| Acme |", "| VP Marketing |", "| Remote |", "| 90/100 |", "| ✅ |"} {
	...
	if reparsed[0].ScoreRaw != "90/100" {
		t.Errorf("reparsed ScoreRaw = %q, want \"90/100\"", reparsed[0].ScoreRaw)
	}
}
...
func TestResolveTrackerColumns(t *testing.T) {
	...
	headerless := []string{"| 1 | 2026-06-01 | Acme | VP Marketing | 90/100 | Applied | ✅ | [1](reports/001.md) | note |"}
...
|---|-------|---------|------|-------|--------|-----|--------|-------|
| 1 | stray | Acme | Engineer | 80/100 | Applied | ✅ | — | real note |`, "\n")
...
|---|------|---------|-----|------|-------|--------|-----|--------|-------|
| 1 | 2026-01-05 | ? | Hays | Data Engineer | 84/100 | Applied | ✅ | — | fintech, Leeds |`, "\n")
...
|---|------|---------|-----|------|-------|--------|-----|--------|-------|
| 28 | 2026-07-10 | ? | DaCodes | Backend Engineer | 62/100 | Evaluated | ✅ | [28](../reports/028-dacodes.md) | note |
`
	path := filepath.Join(dataDir, "applications.md")
	if err := os.WriteFile(path, []byte(applications), 0o644); err != nil {
		t.Fatalf("write tracker: %v", err)
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 3 | 2026-07-10 | Acme | Engineer | 62/100 | Evaluated | ✅ | [3](reports/003.md) | note |
`
	path := filepath.Join(dataDir, "applications.md")
	if err := os.WriteFile(path, []byte(applications), 0o644); err != nil {
		t.Fatalf("write tracker: %v", err)
