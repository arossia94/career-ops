...
|---|------|---------|------|-------|--------|-----|--------|-------|
| 1 | 2026-06-01 | Acme | Backend Engineer | 84/100 | Evaluated | ✅ | [1](../reports/001-acme-2026-06-01.md) | strong infra fit |
| 2 | 2026-06-02 | Globex | Platform Engineer | 80/100 | Evaluated | ✅ | [2](../reports/002-globex-2026-06-02.md) | — |
| 3 | 2026-06-03 | Acme | Data Engineer | 78/100 | Evaluated | ❌ | [3](../reports/003-acme-2026-06-03.md) | pipeline heavy |
`;
...
|---|------|---------|------|----------|-------|--------|-----|--------|-------|
| 1 | 2026-06-01 | Initech | AI Engineer | Remote | 90/100 | Evaluated | ✅ | [1](../reports/001-initech-2026-06-01.md) | — |
`;
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 5 | 2026-05-29 | University of Alberta | Curriculum Coordinator | 76/100 | Evaluated | ❌ | — | — |
| 5 | 2026-06-03 | Esri Canada | Manager Talent and Organizational Development | 82/100 | Evaluated | ❌ | — | — |
`;
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 2 | 2026-06-02 | DriftCo | Platform Engineer | 80/100 | Evaluated | ✅ | [7](../reports/007-driftco-2026-06-02.md) | migrated badly |
`;
...
// ── 1. Update by report number ──────────────────────────────────
{
  ...
  if (r.code === 0 && /\| 2 \| 2026-06-02 \| Globex \| Platform Engineer \| 80\/100 \| Applied \|/.test(content)) {
    pass('by-num: status updated to Applied');
  } else {
    fail(`by-num: code=${r.code}; row not updated correctly\n${r.stdout}${r.stderr}`);
  }
  if (content.includes('| 1 | 2026-06-01 | Acme | Backend Engineer | 84/100 | Evaluated |')) {
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 1 | 2026-06-01 | Contoso | C++ Engineer | 80/100 | Evaluated | ✅ | [1](../reports/001-contoso-2026-06-01.md) | — |
`;
...
// ── 2. Update by company name (single match) ────────────────────
{
  ...
  if (r.code === 0 && /\| Globex \| Platform Engineer \| 80\/100 \| Responded \|/.test(readTracker(sb))) {
...
// ── 3. State aliases resolve to canonical labels ────────────────
{
  ...
  if (r.code === 0 && /\| Globex \| Platform Engineer \| 80\/100 \| Applied \|/.test(readTracker(sb))) {
...
// ── 6. Ambiguous company: candidates listed, --role disambiguates ─
{
  ...
  if (r2.code === 0 && /\| 3 \| 2026-06-03 \| Acme \| Data Engineer \| 78\/100 \| Applied \|/.test(readTracker(sb))) {
...
// ── 6b. Duplicate tracker #: bare number refuses to guess (#1704) ─
{
  ...
  if (readTracker(sb).includes('| 5 | 2026-05-29 | University of Alberta | Curriculum Coordinator | 76/100 | Evaluated |')) {
...
// ── 12. 10-column Location layout ───────────────────────────────
{
  ...
  const content = readTracker(sb);
  if (r.code === 0 && /\| Initech \| AI Engineer \| Remote \| 90\/100 \| Interview \|/.test(content)
...
// ── --on validation (before anything touches the tracker) ───────
{
  ...
  if (badFormat.code === 1 && readTracker(sb).includes('| 2 | 2026-06-02 | Globex | Platform Engineer | 80/100 | Evaluated |')) {
...
// portable across platforms. The status write itself must still succeed.
{
  ...
  let parsed = null;
  try { parsed = JSON.parse(r.stdout); } catch {}
  const trackerUpdated = /\| Globex \| Platform Engineer \| 80\/100 \| Applied \|/.test(readTracker(sb));
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 5 | 2026-06-05 | Globex | Platform Engineer | 80/100 | Evaluated | ✅ | [4](../reports/004-globex-2026-06-05.md) | — |
| 6 | 2026-06-06 | Initech | Data Engineer | 78/100 | Evaluated | ❌ | — | backfilled, no report |
| 7 | 2026-06-07 | Acme | AI Engineer | 88/100 | Evaluated | ✅ | [5](../reports/005-acme-2026-06-07.md) | — |
`;
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 1 | 2026-06-01 | Acme | Engineer | 80/100 | Evaluated | ✅ | [1](../reports/001-acme-2026-06-01.md) | — |
| 4 | 2026-06-04 | Umbrella | Coordinator | N/A | Applied | ❌ | — | backfilled, occupies #4 |
| 5 | 2026-06-05 | Hooli | ML Engineer | 86/100 | Evaluated | ❌ | [4](../reports/004-hooli-2026-06-05.md) | pushed off #4 by the collision |
`;
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 1 | 2026-06-01 | Acme | Backend Engineer | 84/100 | Evaluated | ✅ | [9](../reports/009-acme-2026-06-01.md) | — |
| 2 | 2026-06-02 | Globex | Data Engineer | 80/100 | Evaluated | ✅ | [9](../reports/009-globex-2026-06-02.md) | — |
`;
...
| # | Date | Company | Role | Score | Status | PDF | Report | Notes |
|---|------|---------|------|-------|--------|-----|--------|-------|
| 7 | 2026-06-01 | Initech | Backend Engineer | 84/100 | Evaluated | ✅ | [3](../reports/003-initech-2026-06-01.md) | — |
| 7 | 2026-06-02 | Initech | Data Engineer | 80/100 | Evaluated | ✅ | [3](../reports/003-initech-2026-06-02.md) | — |
`;
    const paths = [
