...
const CONCURRENT_ROW = '| 99 | 2026-01-03 | ConcurrentCo | Keeper | 86/100 | Applied | ❌ | [99](reports/099-concurrent.md) | preserve me |';
let passed = 0;
let failed = 0;
...
await runWhileLocked({
  ...
  content: trackerTable([
    '| 1 | 2026-01-01 | Acme | Engineer | 80/100 | Aplicado | ❌ | [1](reports/001-acme.md) | seed |',
  ]),
...
await runWhileLocked({
  ...
  content: trackerTable([
    '| 1 | 2026-01-01 | Acme | Engineer | 80/100 | Evaluated | ❌ | [1](reports/001-acme.md) | first |',
    '| 2 | 2026-01-02 | Acme | Engineer | 60/100 | Evaluated | ❌ | [2](reports/002-acme.md) | duplicate |',
  ]),
...
await runWhileLocked({
  ...
  args: ['delete', '--num', '1'],
  content: trackerTable([
    '| 1 | 2026-01-01 | Acme | Engineer | 80/100 | Evaluated | ❌ | [1](reports/001-acme.md) | seed |',
    '| 2 | 2026-01-02 | Beta | Analyst | 70/100 | Evaluated | ❌ | [2](reports/002-beta.md) | keep |',
  ]),
...
await runWhileLocked({
  ...
  verify: content => content.includes('| 1 | 2026-01-01 | Acme | Engineer | 80/100 | Applied |')
...
await runWhileLocked({
  ...
  verify: content => content.includes('| 1 | 2026-01-01 | Acme | Engineer | 80/100 | Evaluated | ✅ |'),
...
await runWhileLocked({
  ...
  stdin: 'y\n',
  content: trackerTable([
    '| 1 | 2026-01-01 | Acme | Engineer | 80/100 | Applied | ❌ | [1](reports/001-acme.md) | contact hr@acme.com |',
  ]),
...
await runWhileLocked({
  ...
  verify: content => content.includes('| 1 | 2026-01-01 | Acme | Engineer | 80/100 | Interview |')
...
async function testFollowupSeedUsesASeparateLockNamespace() {
  ...
  const content = trackerTable([
    '| 1 | 2026-01-01 | Acme | Engineer | 80/100 | Applied | ❌ | [1](reports/001-acme.md) | Applied 2026-01-01 |',
  ]);
  writeFileSync(tracker, content);
